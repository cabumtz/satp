...
public class Personafisica implements java.io.Serializable {
     ...
     * 
	 */
	private static final long serialVersionUID = -247804958546466083L;
	...
	public Personafisica(int idPersonaFisica, Entidad entidad, String nombre,
			String apellidoPaterno, String apellidoMaterno,
			Date fechaNacimiento, Miembrofisico miembrofisico) {
		this.idPersonaFisica = idPersonaFisica;
		this.entidad = entidad;
		this.nombre = nombre;
