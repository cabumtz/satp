...
public class Archivo implements java.io.Serializable
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7533562805082504025L;
	...
	public Archivo(Tipomime tipomime, Tipoarchivo tipoarchivo, Entidad entidad,
			String nombre, byte[] dato, Date fechaCreacion)
	{
	...
	public Archivo(Tipomime tipomime, Tipoarchivo tipoarchivo, Entidad entidad,
			String nombre, String descripcion, byte[] dato, Date fechaCreacion,
